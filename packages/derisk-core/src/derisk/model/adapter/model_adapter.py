...
_IS_BENCHMARK = os.getenv("DERISK_MODEL_BENCHMARK", "False").lower() == "true"
...
def get_llm_model_adapter(
    ...
    if use_fastchat:
        ...
        from derisk.model.adapter.fschat_adapter import (
...
def _dynamic_model_parser() -> Optional[List[Type[LLMDeployModelParameters]]]:
    ...
    from derisk.util.parameter_utils import _SimpleArgParser
