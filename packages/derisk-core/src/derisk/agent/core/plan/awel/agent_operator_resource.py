...
@register_resource(
    ...
    alias=[
        "derisk.serve.agent.team.layout.agent_operator_resource.AwelAgentResource",
        "derisk.agent.core.reasoning_engine.awel.agent_operator_resource.AWELAgentResource",
    ],
)
...
def _agent_resource_knowledge_values(
    ...
    from derisk_app.knowledge.api import knowledge_space_service
...
@register_resource(
    ...
    alias=[
        "derisk.serve.agent.team.layout.agent_operator_resource.AwelAgentKnowledgeResource",  # noqa
        "derisk.agent.core.reasoning_engine.awel.agent_operator_resource.AWELAgentKnowledgeResource",
    ],
)
...
@register_resource(
    ...
    alias=[
        "derisk.serve.agent.team.layout.agent_operator_resource.AgentPrompt",
        "derisk.agent.core.reasoning_engine.awel.agent_operator_resource.AgentPrompt",
    ],
)
...
@register_resource(
    ...
    alias=[
        "derisk.serve.agent.team.layout.agent_operator_resource.AwelAgentConfig",
        "derisk.agent.core.reasoning_engine.awel.agent_operator_resource.AWELAgentConfig",
    ],
)
...
@register_resource(
    ...
    alias=[
        "derisk.serve.agent.team.layout.agent_operator_resource.AwelAgent",
        "derisk.agent.core.reasoning_engine.awel.agent_operator_resource.AWELAgent",
    ],
)
