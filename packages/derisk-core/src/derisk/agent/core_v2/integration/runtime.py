                ...
                try:
                    ...
                    try:
                        ...
                        if session.agent and hasattr(session.agent.info, "name"):
                            vis_senders_map[session.agent_name] = session.agent
                            vis_senders_map['agent_name'] = session.agent_name
                            vis_senders_map['agent_state'] = session.state
                            # vis_senders_map[session.agent_name] = session.agent_name
                            logger.debug(
