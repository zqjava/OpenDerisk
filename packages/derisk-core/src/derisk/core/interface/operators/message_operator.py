...
from derisk.core.awel import BaseOperator, MapOperator
from derisk.core.awel.flow import IOField, OperatorCategory, Parameter, ViewMetadata
...
class PreChatHistoryLoadOperator(
    ...
    In DERISK, conversation record and the messages in the conversation are stored in
    the storage,
...
class BufferedConversationMapperOperator(ConversationMapperOperator):
    ...
    Examples:
        .. code-block:: python
            ...
            import asyncio
            from derisk.core.interface.message import AIMessage, HumanMessage
            from derisk.core.operators import BufferedConversationMapperOperator
    ...
    def _filter_round_messages(
        ...
        Examples:
            >>> from derisk.core import AIMessage, HumanMessage
            >>> from derisk.core.operators import BufferedConversationMapperOperator
            >>> messages = [
            ...     [
            ...         HumanMessage(content="Hi", round_index=1),
