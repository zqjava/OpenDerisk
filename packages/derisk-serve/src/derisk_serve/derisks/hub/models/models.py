...
class ServeEntity(Model):
    ...
    name = Column(String(255), unique=True, nullable=False, comment="derisks name")
    description = Column(String(255), nullable=False, comment="derisks description")
    author = Column(String(255), nullable=True, comment="derisks author")
    email = Column(String(255), nullable=True, comment="derisks author email")
    type = Column(String(255), comment="derisks type")
    version = Column(String(255), comment="derisks version")
    storage_channel = Column(String(255), comment="derisks storage channel")
    storage_url = Column(String(255), comment="derisks download url")
    download_param = Column(String(255), comment="derisks download param")
    gmt_created = Column(
        DateTime,
        name="gmt_create",
    ...
    UniqueConstraint("name", "type", name="uk_derisks")
