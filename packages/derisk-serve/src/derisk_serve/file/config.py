...
from derisk.core.interface.file import StorageBackendConfig
from derisk.util.i18n_utils import _
from derisk.util.module_utils import ScannerConfig
from derisk_serve.core import BaseServeConfig

APP_NAME = "file"
SERVE_APP_NAME = "derisk_serve_file"
SERVE_APP_NAME_HUMP = "derisk_serve_File"
SERVE_CONFIG_KEY_PREFIX = "derisk.serve.file."
SERVE_SERVICE_COMPONENT_NAME = f"{SERVE_APP_NAME}_service"
# Database table name
SERVER_APP_TABLE_NAME = "derisk_serve_file"
...
class ServeConfig(BaseServeConfig):
    ...
    __scan_config__ = ScannerConfig(
        module_path="derisk_ext.storage.file",
