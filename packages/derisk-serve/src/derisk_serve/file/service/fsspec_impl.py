...
class DeriskFileSystem(AbstractFileSystem):
    """Interface to files in DeriskFileSystem
...
class DeriskFile(io.IOBase):
    """File-like interface for DeriskFileSystem."""
