...
def load(
    ...
    """Load your local documents to DERISK"""
    from derisk_app.knowledge._cli.knowledge_client import knowledge_init
...
def delete(space_name: str, doc_name: str, y: bool):
    ...
    from derisk_app.knowledge._cli.knowledge_client import knowledge_delete
...
def list(
    ...
    from derisk_app.knowledge._cli.knowledge_client import knowledge_list
