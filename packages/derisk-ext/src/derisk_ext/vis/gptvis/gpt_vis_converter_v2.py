...
from derisk.vis.vis_converter import SystemVisTag, VisProtocolConverter
...
class GptVisConverterNew(VisProtocolConverter):
    ...
    def __init__(self, paths: Optional[str] = None, **kwargs):
        default_tag_paths = ["derisk_ext.vis.gpt_vis.tags", "derisk_ext.vis.common.tags"]
