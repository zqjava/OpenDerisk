...
class GptVisLRConverter(GptVisConverter):
    ...
    async def _message_tasks_vis_build(self, messages: List, plans_map: Optional[Dict[str, GptsPlan]] = None, ):
        num: int = 0
        vis_items: list = []
        task_group: Dict = {}
    ...
    async def _message_tabs_vis_build(self, messages, plans_map: Optional[Dict[str, GptsPlan]] = None, ):
        num: int = 0
        vis_items: list = []
        task_group: Dict = {}
        for message in messages:
