"""AWEL: Simple rag rewrite example
    ...
    .. code-block:: shell
        ...
        curl -X POST $DERISK_SERVER/api/v1/awel/trigger/examples/rag/rewrite \
...
from derisk.rag.operators import QueryRewriteOperator
...
with DAG("derisk_awel_simple_rag_rewrite_example") as dag:
    trigger = HttpTrigger(
