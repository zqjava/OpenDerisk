"""AWEL: Simple chat dag example
    ...
    .. code-block:: shell
        ...
        MODEL="gpt-3.5-turbo"
        curl -X POST $DERISK_SERVER/api/v1/awel/trigger/examples/simple_chat \
...
from derisk.core import ModelMessage, ModelRequest
from derisk.core.awel import DAG, HttpTrigger, MapOperator
from derisk.model.operators import LLMOperator
...
with DAG("derisk_awel_simple_dag_example", tags={"label": "example"}) as dag:
