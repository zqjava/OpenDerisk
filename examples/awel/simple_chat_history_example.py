"""AWEL: Simple chat with history example
    ...
    Examples:
        ...
        .. code-block:: shell
            ...
            MODEL="gpt-3.5-turbo"
            # Fist round
            curl -X POST $DERISK_SERVER/api/v1/awel/trigger/examples/simple_history/multi_round/chat/completions \
...
with DAG("derisk_awel_simple_chat_history") as multi_round_dag:
