...
from derisk.core.awel import JoinOperator, MapOperator
        ...
        parameters=[
            Parameter.build_from(
                ...
                ui=ui.UIPasswordInput(
                    key="derisk.model.openai.api_key",
                ),
            ),
            Parameter.build_from(
                "Model",
...
class ExampleFlowCodeEditorOperator(MapOperator[str, str]):
    ...
    async def execute_code_blocks(self, code_blocks: str, lang: str):
        ...
        from derisk.util.code.server import CodeResult, get_code_server
