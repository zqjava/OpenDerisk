...
This example shows how to use AWEL to build a simple rag summary example.
    ...
    .. code-block:: shell
        ...
        -H "Content-Type: application/json" -d '{
            "url": "https://docs.derisk.site/docs/awel"
        }'
"""
...
from derisk_ext.rag.operators import KnowledgeOperator, SummaryAssemblerOperator
...
with DAG("derisk_awel_simple_rag_summary_example") as dag:
    trigger = HttpTrigger(
