...
from derisk_ext.rag.assembler.bm25 import BM25Assembler
from derisk_ext.rag.knowledge import KnowledgeFactory
from derisk_ext.storage.vector_store.elastic_store import ElasticsearchVectorConfig
...
"""Embedding rag example.
    ...
    Examples:
        ..code-block:: shell
            uv run examples/rag/bm25_retriever_example.py
"""
