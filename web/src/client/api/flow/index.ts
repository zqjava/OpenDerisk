...
export const uploadFile = (data: IUploadFileRequestParams) => {
  return POST<IUploadFileRequestParams, Array<IUploadFileResponse>>('/api/v2/serve/file/files/derisk', data);
};

export const downloadFile = (fileId: string) => {
  return GET<null, any>(`/api/v2/serve/file/files/derisk/${fileId}`);
};
